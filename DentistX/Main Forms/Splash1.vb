...
Public Class Splash1
    ...
    Public Enum SplashScreenCommand
        SomeCommandId
    End Enum
    Private Sub Splash1_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Async Sub Splash1_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Dim sw = StartTimer()
        sw.Start()
...
'Private Async Sub Splash1_LoadAsync(sender As Object, e As EventArgs) Handles Me.Load
