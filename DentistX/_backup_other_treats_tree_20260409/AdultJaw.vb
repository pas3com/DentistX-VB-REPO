    ...
    Public Sub LoadTeethTreatsUsingTreatCode(patientTreats As IEnumerable(Of Patient_ToothTrt))
        ...
        Try
            ...
            For Each ct As Control In JawPanel.Controls.OfType(Of SvgImageBox)()
                ...
                TreatHelper.ProcessToothTreatments(svg, svgExternalList, patientTreats, IsMobile)
                svg.EndUpdate()
            Next
    ...
    Private Sub AddedTrtsList_KeyDown(sender As Object, e As KeyEventArgs) Handles AddedTrtsList.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If selectedRow IsNot Nothing Then
                ...
                Dim toothTrt As New Patient_ToothTrt With {.ToothTrtID = ToothTrtID, .PatientID = PatientID, .ToothNum = CByte(slctdSVG.Tag)}
                toothTrt = trtData.Select_RecordByTrtIDByTNum(toothTrt)
                'CLOSE flyout1
                Flyout1.HidePopup()
                Dim result As DialogResult
