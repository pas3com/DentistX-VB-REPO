...
Public Class DelTreatFrom1
    ...
    Private Sub btnDelTrt_Click(sender As Object, e As EventArgs) Handles btnDelTrt.Click
        ...
        Dim msgEn As String = "Are you sure you want to delete these " & BS.Count & " treatments?"
        Dim msgAr As String = "هل أنت متأكد أنك تريد حذف هذه " & BS.Count & " العلاجات؟"
