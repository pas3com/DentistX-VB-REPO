...
Public Class PatientInvPaysRep
    ...
    Private Sub XrLabel34_BeforePrint(sender As Object, e As CancelEventArgs) Handles XrLabel34.BeforePrint
        FormatCurrencyControl(sender)
    End Sub

    Private Sub XrLabel35_BeforePrint(sender As Object, e As CancelEventArgs) Handles XrLabel35.BeforePrint
        FormatCurrencyControl(sender)
    End Sub
