...
#Region "The Class"
    ...
    Public Sub New()
        ...
        'LogToFile("KidUpperDiag_New Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)

        'LoadPatientTreats(PatientID)
        LogTime("KidUpperDiag_New", Me.Name, sw)
    End Sub
    ...
    Public Sub New(ByVal PatientID As Integer) ', hideDiv As Boolean)
        ...
        sw.Stop()
        LogToFile("KidUpperDiag_NewByVal PatientID Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
    End Sub
...
#Region "Loading"
    ...
    Private Sub KidUpperDiag_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sw = StartTimer()
        'Dim sw As New Stopwatch
        'sw.Start()
        ...
        'LogToFile("KidUpperDiag_Load Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        LogTime(NameOf(KidUpperDiag_Load), Me.Name, sw)
    End Sub
    ...
    Private Sub KidUpperDiag_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If controlBoundsCache.IsEmpty Then Return
        ResizeControlsProportionally()
        ALIGNS()
    End Sub
...
#Region "FlyOutEvents"
    ...
    Private NotInheritable Class FlyMenuOutsideClickFilter
        ...
        Private ReadOnly _jaw As KidUpperDiag

        Public Sub New(jaw As KidUpperDiag)
            _jaw = jaw
        End Sub
...
#Region "Aligning"
    Public Sub AlignTops()
        ...
        Dim rdINTop As Integer = RUINK1.Top
    ...
    Private Sub KidUpperDiag_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
