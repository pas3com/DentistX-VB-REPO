...
#Region "The Class"
    ...
    Public Sub New()
        ...
        'LogToFile("KidLowerDiag_New Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)

        'LoadPatientTreats(PatientID)
        LogTime("KidLowerDiag_New", Me.Name, sw)
    End Sub
    ...
    Public Sub New(ByVal PatientID As Integer) ', hideDiv As Boolean)
        ...
        sw.Stop()
        LogToFile("KidLowerDiag_NewByVal PatientID Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
    End Sub
...
#End Region
    ...
    Private Sub CommonMouseClickHandler(sender As Object, e As MouseEventArgs)
        ...
        If e.Button = MouseButtons.Right Then
            ...
            JawFlyMenuRuntime.PositionFlyMenuForTooth(FlyMenu, svg, StringComparison.OrdinalIgnoreCase, anchorToTopRow:=True)
...
#Region "Loading"
    ...
    Private Sub KidLowerDiag_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sw = StartTimer()
        'Dim sw As New Stopwatch
        'sw.Start()
        ...
        'LogToFile("KidLowerDiag_Load Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        LogTime(NameOf(KidLowerDiag_Load), Me.Name, sw)
    End Sub
    ...
    Private Sub KidLowerDiag_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If controlBoundsCache.IsEmpty Then Return
        ResizeControlsProportionally()
        ALIGNS()
    End Sub
...
#Region "FlyOutEvents"
    ...
    Private NotInheritable Class FlyMenuOutsideClickFilter
        ...
        Private ReadOnly _jaw As KidLowerDiag

        Public Sub New(jaw As KidLowerDiag)
            _jaw = jaw
        End Sub
...
#Region "Aligning"
    Public Sub AlignTops()
        ...
        Dim ruINTop As Integer = RDINK1.Top
    ...
    Public Sub ALIGNS()
        ...
        ' Align IN views
        AlignHorizontally(leftToRightPrefixes, "INK", False)  ' Lu/Ld: Left-to-right
        AlignHorizontally(rightToLeftPrefixes, "INK", True)   ' Ru/Rd: Right-to-left
    End Sub

    Private Sub KidLowerDiag_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
