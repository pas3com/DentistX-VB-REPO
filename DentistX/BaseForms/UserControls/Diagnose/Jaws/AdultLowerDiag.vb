...
#Region "The Class"
    ...
    Public Sub New()
        ...
        'LogToFile("AdultLowerDiag_New Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)

        'LoadPatientTreats(PatientID)
        LogTime("AdultLowerDiag_New", Me.Name, sw)
    End Sub
    ...
    Public Sub New(ByVal PatientID As Integer) ', hideDiv As Boolean)
        ...
        sw.Stop()
        LogToFile("AdultLowerDiag_NewByVal PatientID Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
    End Sub
...
#Region "New TreeViewSource"
    ...
    ' Uses TrtSourceHelper.TrtNodeInfo for diagnosis tree
...
#Region "Loading"
    ...
    Private Sub AdultLowerDiag_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sw = StartTimer()
        'Dim sw As New Stopwatch
        'sw.Start()
    ...
    Private Sub AdultLowerDiag_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If controlBoundsCache.IsEmpty Then Return
        ResizeControlsProportionally()
        ALIGNS()
    End Sub
