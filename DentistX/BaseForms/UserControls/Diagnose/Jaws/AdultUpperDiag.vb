...
#Region "The Class"
    ...
    Public Sub New()
        ...
        'LogToFile("AdultUpperDiag_New Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)

        'LoadPatientTreats(PatientID)
        LogTime("AdultUpperDiag_New", Me.Name, sw)
    End Sub
    ...
    Public Sub New(ByVal PatientID As Integer) ', hideDiv As Boolean)
        ...
        sw.Stop()
        LogToFile("AdultUpperDiag_NewByVal PatientID Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
    End Sub
...
#Region "Loading"
    ...
    Private Sub AdultUpperDiag_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sw = StartTimer()
        'Dim sw As New Stopwatch
        'sw.Start()
        ...
        'LogToFile("AdultUpperDiag_Load Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        LogTime(NameOf(AdultUpperDiag_Load), Me.Name, sw)
    End Sub
    ...
    Private Sub AdultUpperDiag_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If controlBoundsCache.IsEmpty Then Return
        ResizeControlsProportionally()
        ALIGNS()
    End Sub
...
#Region "FlyOutEvents"
    ...
    Private NotInheritable Class FlyMenuOutsideClickFilter
        ...
        Private ReadOnly _jaw As AdultUpperDiag

        Public Sub New(jaw As AdultUpperDiag)
            _jaw = jaw
        End Sub
...
#Region "Aligning"
    ...
    Private Sub AdultUpperDiag_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
