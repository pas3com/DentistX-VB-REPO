...
Public Class PatientRXTreeFrm
    ...
    Private Sub PatientRXTreeFrm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub PatientRXTreeFrm_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub PatientRXTreeFrm_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
    End Sub
...
#End Region
    ...
    Private Sub AddSubNodeOld(ByVal Node As TreeNode, ByVal Level As String, ByVal ParentID As Integer)
        'Try
        '    Select Case Level
        '        Case "MedicineGroups"
