...
''' <summary>
''' Doctors day: single-day painted timeline with calm hour grid, doctor columns, and <see cref="ApptCardCtl"/> blocks
''' (<see cref="ApptViewMode.DoctorsDay"/>). Same layout model as the former <c>ApptDayCtl</c> implementation.
''' To use <see cref="HtmlCard"/> instead, replace <c>ApptCardCtl</c> with <c>HtmlCard</c> here and in <see cref="ApptDayCtl"/>.
''' </summary>
    ...
    Private NotInheritable Class DayDoctorsTimelineCanvas
        ...
        Protected Overrides Sub OnMouseDoubleClick(e As MouseEventArgs)
            ...
            For Each c As Control In Controls
                If TypeOf c Is ApptCardCtl AndAlso c.Bounds.Contains(e.Location) Then Return
            Next
