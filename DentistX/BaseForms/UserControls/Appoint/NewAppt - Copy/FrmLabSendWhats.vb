...
Partial Public Class FrmLabSendWhats
    ...
    Private Sub BindLabLookUpWhatsOnly()
        Try
            ...
            If list.Count > 0 Then
                lookUpSource.EditValue = list(0).Id
            End If
        Catch ex As Exception
            ApptErrorHelper.Report(ex,
    ...
    Private Function BuildMessageText() As String
        ...
        Dim labName = If(lookUpSource.Text, "").Trim()
        ...
        If GetSelectedLabId() > 0 AndAlso Not String.IsNullOrWhiteSpace(labName) Then
            If lines.Count > 0 Then lines.Add("")
            lines.Add(If(UseMessageEnglish, "Lab: ", "المختبر: ") & labName)
        End If
    ...
    Private Sub lookUpSource_EditValueChanged(sender As Object, e As EventArgs) Handles lookUpSource.EditValueChanged
