...
#Region "═══ 3. FILTER PROPERTIES ═══"
    ...
    ''' <summary>Baseline relative row weights for <see cref="filtersTable"/> (must match SchedulerNew2.Designer).</summary>
...
#Region "═══ DOCTORS DAY — APPOINTMENT HOST CONTROL ═══"
    ...
    Private Class DoctorsDayAppointmentHost
        ...
        Public Sub New(owner As SchedulerNew2, ap As AppointmentC, doctorColor As Color, statusBack As Color,
...
''' <summary>Preview for <see cref="SchedulerNew2"/> snapshot: Save, WhatsApp, or Cancel. Takes ownership of the preview image.</summary>
            ...
            For Each recipient In recipients
                Try
                    Dim ctx As New WhatsAppSendContext With {
                        ...
                        .SourceHint = NameOf(SchedulerNew2) & " · Schedule snapshot",
