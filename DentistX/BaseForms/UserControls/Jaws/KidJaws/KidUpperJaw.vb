...
#Region "The Class"
    ...
    Public Sub New()
        ...
        'LogToFile("KidUpperJaw_New Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        'LoadPatientTreats(PatientID)
        LogTime("KidUpperJaw_New", Me.Name, sw)
    End Sub
    ...
    Public Sub New(ByVal PatientID As Integer) ', hideDiv As Boolean)
        ...
        sw.Stop()
        LogToFile("KidUpperJaw_NewByVal PatientID Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
    End Sub
...
#Region "Loading"
    ...
    Private Sub KidUpperJaw_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sw = StartTimer()
        'Dim sw As New Stopwatch
        'sw.Start()
        ...
        'LogToFile("KidUpperJaw_Load Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        LogTime(NameOf(KidUpperJaw_Load), Me.Name, sw)
    End Sub
    ...
    Private Sub KidUpperJaw_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If controlBoundsCache.IsEmpty Then Return
        ResizeControlsProportionally()
        ALIGNS()
    End Sub
...
#Region "FlyOutEvents"
    ...
    Private NotInheritable Class FlyMenuOutsideClickFilter
        ...
        Private ReadOnly _jaw As KidUpperJaw

        Public Sub New(jaw As KidUpperJaw)
            _jaw = jaw
        End Sub
...
#Region "Aligning"
    ...
    Private Sub KidUpperJaw_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
