...
#Region "The Class"
    ...
    Public Sub New()
        ...
        'LogToFile("KidLowerJaw_New Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        'LoadPatientTreats(PatientID)
        LogTime("KidLowerJaw_New", Me.Name, sw)
    End Sub
    ...
    Public Sub New(ByVal PatientID As Integer) ', hideDiv As Boolean)
        ...
        sw.Stop()
        LogToFile("KidLowerJaw_NewByVal PatientID Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
    End Sub
...
#Region "Loading"
    ...
    Private Sub KidLowerJaw_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sw = StartTimer()
        'Dim sw As New Stopwatch
        'sw.Start()
        ...
        'LogToFile("KidLowerJaw_Load Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        LogTime(NameOf(KidLowerJaw_Load), Me.Name, sw)
    End Sub
    ...
    Private Sub KidLowerJaw_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If controlBoundsCache.IsEmpty Then Return
        ResizeControlsProportionally()
        ALIGNS()
    End Sub
...
#Region "FlyOutEvents"
    ...
    Private NotInheritable Class FlyMenuOutsideClickFilter
        ...
        Private ReadOnly _jaw As KidLowerJaw

        Public Sub New(jaw As KidLowerJaw)
            _jaw = jaw
        End Sub
...
#Region "Aligning"
    ...
    Private Sub KidLowerJaw_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
