...
Imports DevExpress.Utils.Svg 'Imports DevExpress.Data.Svg
Imports DevExpress.XtraEditors
Imports Infragistics.Win.UltraWinGrid
'AdultUpperJaw

Public Class AdultUpperJaw
...
#Region "The Class"
    ...
    Public Sub New()
        ...
        'LogToFile("AdultUpperJaw_New Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        'LoadPatientTreats(PatientID)
        LogTime("AdultUpperJaw_New", Me.Name, sw)
    End Sub
    ...
    Public Sub New(ByVal PatientID As Integer) ', hideDiv As Boolean)
        ...
        sw.Stop()
        LogToFile("AdultUpperJaw_NewByVal PatientID Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
    End Sub
...
#Region "Loading"
    ...
    Private Sub AdultUpperJaw_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim sw = StartTimer()
        'Dim sw As New Stopwatch
        'sw.Start()
        ...
        'sw.Stop()
        'LogToFile("AdultUpperJaw_Load Time spent: " & sw.Elapsed.TotalSeconds.ToString("F2") & " seconds", Me)
        LogTime(NameOf(AdultUpperJaw_Load), Me.Name, sw)
    End Sub
    ...
    Private Sub AdultUpperJaw_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If controlBoundsCache.IsEmpty Then Return
        ResizeControlsProportionally()
        ALIGNS()
    End Sub
...
#Region "FlyOutEvents"
    ...
    Private NotInheritable Class FlyMenuOutsideClickFilter
        ...
        Private ReadOnly _jaw As AdultUpperJaw

        Public Sub New(jaw As AdultUpperJaw)
            _jaw = jaw
        End Sub
...
#Region "Aligning"
    Public Sub AlignTops()
        ...
        Dim ruINTop As Integer = RuIN1.Top
    ...
    Private Sub AdultUpperJaw_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
