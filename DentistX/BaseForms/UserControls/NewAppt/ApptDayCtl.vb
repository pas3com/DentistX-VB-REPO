...
''' transparent doctor columns for empty double-clicks, and time-scaled <see cref="HtmlCard"/> blocks
''' (same layout model as <see cref="SchedulerNew.RenderDayView"/>).
''' </summary>
Public Class ApptDayCtl
    ...
    Private Sub WireCard(card As HtmlCard, day As Date)
    ...
    Private Sub RelayWeekDragDown(card As HtmlCard, day As Date, e As MouseEventArgs)
        ' Redirected to OnCardDragMouseDown
    End Sub

    Private Sub RelayWeekDragUp(card As HtmlCard, e As MouseEventArgs)
