...
''' <summary>Legacy WinForms week/drawer appointment card (layout matches <see cref="ApptCardCtl"/>). Week columns use <see cref="HtmlCard"/> instead.</summary>
Partial Public Class ApptCard
    ...
    ''' <summary>Same as <see cref="ApptCardCtl.ApplyContentHeightToFitForWeekView"/> — kept for this control; <see cref="ApptWeekCtl"/> uses <see cref="HtmlCard"/>.</summary>
