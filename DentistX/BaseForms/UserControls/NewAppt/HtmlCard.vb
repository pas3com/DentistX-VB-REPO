...
''' <summary>Appointment card: <see cref="ApptCardVm"/> body as DevExpress HTML on <see cref="LabelControl"/>, vertical status strip (<see cref="ApptCardStatusLabel"/>) docked right — same data contract as <see cref="ApptCardCtl"/>.</summary>
Public Class HtmlCard
    ...
    Friend Sub ApplyContentHeightToFitForWeekView()
        ...
        Dim h = Padding.Vertical + LabelControl1.Padding.Top + LabelControl1.Padding.Bottom + sz.Height
        h = Math.Max(1, h)
