...
CREATE TABLE dbo.SchedulerSnapshotAutoSendJob (
    ...
    /* 0=PNG only, 1=HTML only, 2=PNG+HTML. See SchedulerSnapshotAutoSendRepository.SendContentMode. */
    SendContentMode  TINYINT NOT NULL CONSTRAINT DF_SSAJ_SendContentMode DEFAULT (0),
