...
#Region "Windows Form Designer generated code"
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmVisitTypes))
        ...
        Me.colVisitTypeAr = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.VtIDLabel = New DevExpress.XtraEditors.LabelControl()
        Me.VtIDSpinEdit = New DevExpress.XtraEditors.SpinEdit()
        Me.VisitTypeLabel = New DevExpress.XtraEditors.LabelControl()
        Me.VisitTypeTextEdit = New DevExpress.XtraEditors.TextEdit()
        Me.VisitTypeArLabel = New DevExpress.XtraEditors.LabelControl()
        Me.VisitTypeArTextEdit = New DevExpress.XtraEditors.TextEdit()
        ...
        CType(Me.VtIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.VisitTypeTextEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.VisitTypeArTextEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.dgView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colRowNum, Me.colVtID, Me.colVisitType, Me.colVisitTypeAr})
        ...
        'colVtID
        '
        resources.ApplyResources(Me.colVtID, "colVtID")
        Me.colVtID.FieldName = "VtID"
        Me.colVtID.ImageOptions.ImageKey = resources.GetString("colVtID.ImageOptions.ImageKey")
        ...
        'colVisitTypeAr
        '
        resources.ApplyResources(Me.colVisitTypeAr, "colVisitTypeAr")
        Me.colVisitTypeAr.FieldName = "VisitTypeAr"
        Me.colVisitTypeAr.ImageOptions.ImageKey = resources.GetString("colVisitTypeAr.ImageOptions.ImageKey")
        Me.colVisitTypeAr.Name = "colVisitTypeAr"
        Me.colVisitTypeAr.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem()})
        '
        'ribbonControl
        '
        ...
        Me.TableData.Controls.Add(Me.VtIDLabel)
        Me.TableData.Controls.Add(Me.VtIDSpinEdit)
        Me.TableData.Controls.Add(Me.VisitTypeLabel)
        Me.TableData.Controls.Add(Me.VisitTypeTextEdit)
        Me.TableData.Controls.Add(Me.VisitTypeArLabel)
        Me.TableData.Controls.Add(Me.VisitTypeArTextEdit)
        ...
        'VtIDLabel
        '
        resources.ApplyResources(Me.VtIDLabel, "VtIDLabel")
        Me.VtIDLabel.Appearance.Font = CType(resources.GetObject("VtIDLabel.Appearance.Font"), System.Drawing.Font)
        Me.VtIDLabel.Appearance.Options.UseFont = True
        Me.VtIDLabel.Appearance.Options.UseTextOptions = True
        Me.VtIDLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.VtIDLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.VtIDLabel, 1)
        Me.VtIDLabel.Name = "VtIDLabel"
        Me.TableData.SetRow(Me.VtIDLabel, 0)
        '
        'VtIDSpinEdit
        '
        resources.ApplyResources(Me.VtIDSpinEdit, "VtIDSpinEdit")
        Me.TableData.SetColumn(Me.VtIDSpinEdit, 2)
        Me.VtIDSpinEdit.Name = "VtIDSpinEdit"
        Me.VtIDSpinEdit.Properties.Appearance.Font = CType(resources.GetObject("VtIDSpinEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.VtIDSpinEdit.Properties.Appearance.Options.UseFont = True
        Me.VtIDSpinEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.VtIDSpinEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.VtIDSpinEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.VtIDSpinEdit, 0)
        '
        'VisitTypeLabel
        '
        resources.ApplyResources(Me.VisitTypeLabel, "VisitTypeLabel")
        Me.VisitTypeLabel.Appearance.Font = CType(resources.GetObject("VisitTypeLabel.Appearance.Font"), System.Drawing.Font)
        Me.VisitTypeLabel.Appearance.Options.UseFont = True
        Me.VisitTypeLabel.Appearance.Options.UseTextOptions = True
        Me.VisitTypeLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.VisitTypeLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.VisitTypeLabel, 4)
        Me.VisitTypeLabel.Name = "VisitTypeLabel"
        Me.TableData.SetRow(Me.VisitTypeLabel, 0)
        '
        'VisitTypeTextEdit
        '
        resources.ApplyResources(Me.VisitTypeTextEdit, "VisitTypeTextEdit")
        Me.TableData.SetColumn(Me.VisitTypeTextEdit, 5)
        Me.VisitTypeTextEdit.Name = "VisitTypeTextEdit"
        Me.VisitTypeTextEdit.Properties.Appearance.Font = CType(resources.GetObject("VisitTypeTextEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.VisitTypeTextEdit.Properties.Appearance.Options.UseFont = True
        Me.VisitTypeTextEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.VisitTypeTextEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.VisitTypeTextEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.VisitTypeTextEdit, 0)
        '
        'VisitTypeArLabel
        '
        resources.ApplyResources(Me.VisitTypeArLabel, "VisitTypeArLabel")
        Me.VisitTypeArLabel.Appearance.Font = CType(resources.GetObject("VisitTypeArLabel.Appearance.Font"), System.Drawing.Font)
        Me.VisitTypeArLabel.Appearance.Options.UseFont = True
        Me.VisitTypeArLabel.Appearance.Options.UseTextOptions = True
        Me.VisitTypeArLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.VisitTypeArLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.VisitTypeArLabel, 1)
        Me.VisitTypeArLabel.Name = "VisitTypeArLabel"
        Me.TableData.SetRow(Me.VisitTypeArLabel, 1)
        '
        'VisitTypeArTextEdit
        '
        resources.ApplyResources(Me.VisitTypeArTextEdit, "VisitTypeArTextEdit")
        Me.TableData.SetColumn(Me.VisitTypeArTextEdit, 2)
        Me.VisitTypeArTextEdit.Name = "VisitTypeArTextEdit"
        Me.VisitTypeArTextEdit.Properties.Appearance.Font = CType(resources.GetObject("VisitTypeArTextEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.VisitTypeArTextEdit.Properties.Appearance.Options.UseFont = True
        Me.VisitTypeArTextEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.VisitTypeArTextEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.VisitTypeArTextEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.VisitTypeArTextEdit, 1)
        '
        'TLPBut
        '
        ...
        CType(Me.VtIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.VisitTypeTextEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.VisitTypeArTextEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private WithEvents DGV As DevExpress.XtraGrid.GridControl
		...
		Friend WithEvents VtIDSpinEdit As DevExpress.XtraEditors.SpinEdit
		Friend WithEvents VtIDLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colVtID As DevExpress.XtraGrid.Columns.GridColumn
		Friend WithEvents VisitTypeTextEdit As DevExpress.XtraEditors.TextEdit
		Friend WithEvents VisitTypeLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colVisitType As DevExpress.XtraGrid.Columns.GridColumn
		Friend WithEvents VisitTypeArTextEdit As DevExpress.XtraEditors.TextEdit
		Friend WithEvents VisitTypeArLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colVisitTypeAr As DevExpress.XtraGrid.Columns.GridColumn
