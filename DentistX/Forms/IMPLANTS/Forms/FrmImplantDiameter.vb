...
Partial Public Class FrmImplantDiameter
    ...
    End Sub
    Private clsImplantDiameterData As New ImplantDiameterDATA
    Private clsDentistXData As New DentistXDATA


    Private Sub FrmImplantDiameter_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        LoadDGV()
    ...
    Private Sub LoadDGV()
        Try
            With DGV
                .DataSource = clsImplantDiameterData.SelectAll
    ...
    Private Sub EnableRecord(ByVal YesNo As Boolean)
        'DiameterIDSpinEdit.Enabled = YesNo
        DiameterMMSpinEdit.Enabled = YesNo
    End Sub
    ...
    Private Sub Display()
        ClearRecord()
        Dim clsImplantDiameter As New ImplantDiameter
        clsImplantDiameter.DiameterID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colDiameterID))
        clsImplantDiameter = clsImplantDiameterData.Select_Record(clsImplantDiameter)
        If Not clsImplantDiameter Is Nothing Then
            Try
                ' Controls will automatically format as N2 based on designer settings
                DiameterIDSpinEdit.Value = System.Convert.ToInt32(clsImplantDiameter.DiameterID)
                DiameterMMSpinEdit.Value = System.Convert.ToDecimal(clsImplantDiameter.DiameterMM)
            Catch ex As Exception
                MsgBox(ex.Message)
            End Try
        End If
    ...
    Private Sub Add()
        ...
        DiameterIDSpinEdit.Select()
        DiameterIDSpinEdit.Text = DentistXDATA.getAutoID("New", "ImplantDiameter")
    End Sub
    ...
    Private Sub ClearRecord()
        DiameterIDSpinEdit.Value = 0
        'DiameterMMTextEdit.Text = Nothing
    End Sub
    ...
    End Sub
    Private Sub SetData(ByVal clsImplantDiameter As ImplantDiameter)
        With clsImplantDiameter
            .DiameterID = System.Convert.ToInt32(DiameterIDSpinEdit.Value)
            .DiameterMM = System.Convert.ToDecimal(DiameterMMSpinEdit.Value)
        End With
    End Sub
    ...
    Private Sub InsertRecord()
        ...
        If VerifyData() = True Then
            SetData(clsImplantDiameter)
            Dim bSuccess As Boolean
            bSuccess = clsImplantDiameterData.Add(clsImplantDiameter)
    ...
    Private Sub UpdateRecord()
        Dim oclsImplantDiameter As New ImplantDiameter
        Dim clsImplantDiameter As New ImplantDiameter
        oclsImplantDiameter.DiameterID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colDiameterID))
        oclsImplantDiameter = clsImplantDiameterData.Select_Record(oclsImplantDiameter)
        If VerifyData() = True Then
            SetData(clsImplantDiameter)
            Dim bSuccess As Boolean
            bSuccess = clsImplantDiameterData.Update(oclsImplantDiameter, clsImplantDiameter)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Sub DeleteRecord()
        ...
        If result = DialogResult.Yes Then
            Dim bSuccess As Boolean
            bSuccess = clsImplantDiameterData.Delete(clsImplantDiameter)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Function VerifyData() As Boolean
        ...
        If DiameterIDSpinEdit.Value = Nothing OrElse DiameterIDSpinEdit.Value.ToString() = "" Then
            MsgBox("DiameterID is required.", MsgBoxStyle.OkOnly, "Entry Error")
            DiameterIDSpinEdit.Select()
            Return False
        End If
        If DiameterMMSpinEdit.Value = Nothing OrElse DiameterMMSpinEdit.Value.ToString() = "" Then
            MsgBox("DiameterMM is required.", MsgBoxStyle.OkOnly, "Entry Error")
