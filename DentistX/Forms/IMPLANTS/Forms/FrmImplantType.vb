...
Partial Public Class FrmImplantType
 ...
 End Sub
 Private clsImplantTypeData As New ImplantTypeData
 Private clsDentistXData As New DentistXData
 
 
 Private Sub FrmImplantType_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
     LoadDGV()
 ...
 Private Sub LoadDGV()
     Try
         With DGV
             .DataSource = clsImplantTypeData.SelectAll
 ...
 Private Sub EnableRecord(ByVal YesNo As Boolean)
        TypeNameTextEdit.Enabled = YesNo
        IsSlimCheckEdit.Enabled = YesNo
 End Sub
 ...
 Private Sub Display()
     ClearRecord()
     Dim clsImplantType As New ImplantType
        clsImplantType.TypeID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colTypeID))
    clsImplantType = clsImplantTypeData.Select_Record(clsImplantType)
     If Not clsImplantType Is Nothing Then
     Try
        TypeIDSpinEdit.Value = System.Convert.ToInt32(clsImplantType.TypeID)
        TypeNameTextEdit.Text = Convert.ToString(clsImplantType.TypeName)
        IsSlimCheckEdit.Checked = System.Convert.ToBoolean(clsImplantType.IsSlim)
     Catch ex As Exception
          MsgBox(ex.Message)
     End Try
     End If
 ...
 Private Sub ClearRecord()
    ...
    TypeNameTextEdit.Text = Nothing
    IsSlimCheckEdit.Checked = False
 End Sub
 ...
 End Sub
    ...
    Private Sub InsertRecord()
        ...
        If VerifyData() = True Then
            SetData(clsImplantType)
            Dim bSuccess As Boolean
            bSuccess = clsImplantTypeData.Add(clsImplantType)
    ...
    Private Sub UpdateRecord()
        Dim oclsImplantType As New ImplantType
        Dim clsImplantType As New ImplantType
        oclsImplantType.TypeID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colTypeID))
        oclsImplantType = clsImplantTypeData.Select_Record(oclsImplantType)
        If VerifyData() = True Then
            SetData(clsImplantType)
            Dim bSuccess As Boolean
            bSuccess = clsImplantTypeData.Update(oclsImplantType, clsImplantType)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Sub DeleteRecord()
        ...
        If result = DialogResult.Yes Then
            Dim bSuccess As Boolean
            bSuccess = clsImplantTypeData.Delete(clsImplantType)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Function VerifyData() As Boolean
        ...
        If clsImplantTypeData.CountByTypeName(typeNm, excludeId) > 0 Then
            ...
            Return False
        End If
        If Not IsSlimCheckEdit.Checked = False Then
            MsgBox("IsSlim is required.", MsgBoxStyle.OkOnly, "Entry Error")
            IsSlimCheckEdit.Select()
            Return False
        End If
        Return True
    End Function
