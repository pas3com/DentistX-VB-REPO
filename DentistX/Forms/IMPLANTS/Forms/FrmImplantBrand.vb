...
Partial Public Class FrmImplantBrand
 ...
 End Sub
 Private clsImplantBrandData As New ImplantBrandData
 Private clsDentistXData As New DentistXData
 
 
 Private Sub FrmImplantBrand_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
     LoadDGV()
 ...
 Private Sub LoadDGV()
     Try
         With DGV
             .DataSource = clsImplantBrandData.SelectAll
 ...
 Private Sub EnableRecord(ByVal YesNo As Boolean)
        BrandIDSpinEdit.Enabled = YesNo
        BrandNameTextEdit.Enabled = YesNo
 End Sub
 ...
 Private Sub Display()
     ClearRecord()
     Dim clsImplantBrand As New ImplantBrand
        clsImplantBrand.BrandID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colBrandID))
    clsImplantBrand = clsImplantBrandData.Select_Record(clsImplantBrand)
     If Not clsImplantBrand Is Nothing Then
     Try
        BrandIDSpinEdit.Value = System.Convert.ToInt32(clsImplantBrand.BrandID)
        BrandNameTextEdit.Text = Convert.ToString(clsImplantBrand.BrandName)
     Catch ex As Exception
          MsgBox(ex.Message)
     End Try
     End If
 ...
 Private Sub ClearRecord()
    BrandIDSpinEdit.Value = 0
    BrandNameTextEdit.Text = Nothing
 End Sub
 ...
 End Sub
    ...
    Private Sub InsertRecord()
        ...
        If VerifyData() = True Then
            SetData(clsImplantBrand)
            Dim bSuccess As Boolean
            bSuccess = clsImplantBrandData.Add(clsImplantBrand)
    ...
    Private Sub UpdateRecord()
        Dim oclsImplantBrand As New ImplantBrand
        Dim clsImplantBrand As New ImplantBrand
        oclsImplantBrand.BrandID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colBrandID))
        oclsImplantBrand = clsImplantBrandData.Select_Record(oclsImplantBrand)
        If VerifyData() = True Then
            SetData(clsImplantBrand)
            Dim bSuccess As Boolean
            bSuccess = clsImplantBrandData.Update(oclsImplantBrand, clsImplantBrand)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Sub DeleteRecord()
        ...
        If result = DialogResult.Yes Then
            Dim bSuccess As Boolean
            bSuccess = clsImplantBrandData.Delete(clsImplantBrand)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Function VerifyData() As Boolean
        ...
        If BrandIDSpinEdit.Value = Nothing OrElse BrandIDSpinEdit.Value.ToString() = "" Then
            MsgBox("BrandID is required.", MsgBoxStyle.OkOnly, "Entry Error")
            BrandIDSpinEdit.Select()
            Return False
        End If
