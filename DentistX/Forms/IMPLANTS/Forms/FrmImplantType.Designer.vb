...
#Region "Windows Form Designer generated code"
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmImplantType))
        ...
        Me.colTypeName = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIsSlim = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.TypeNameLabel = New DevExpress.XtraEditors.LabelControl()
        Me.TypeNameTextEdit = New DevExpress.XtraEditors.TextEdit()
        Me.IsSlimLabel = New DevExpress.XtraEditors.LabelControl()
        Me.IsSlimCheckEdit = New DevExpress.XtraEditors.CheckEdit()
        ...
        CType(Me.TypeNameTextEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.IsSlimCheckEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.dgView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colRowNum, Me.colTypeID, Me.colTypeName, Me.colIsSlim})
        ...
        'colIsSlim
        '
        Me.colIsSlim.FieldName = "IsSlim"
        Me.colIsSlim.Name = "colIsSlim"
        resources.ApplyResources(Me.colIsSlim, "colIsSlim")
        '
        'ribbonControl
        '
        ...
        Me.TableData.Controls.Add(Me.TypeNameLabel)
        Me.TableData.Controls.Add(Me.TypeNameTextEdit)
        Me.TableData.Controls.Add(Me.IsSlimLabel)
        Me.TableData.Controls.Add(Me.IsSlimCheckEdit)
        ...
        'TypeNameLabel
        '
        Me.TypeNameLabel.Appearance.Font = CType(resources.GetObject("TypeNameLabel.Appearance.Font"), System.Drawing.Font)
        Me.TypeNameLabel.Appearance.Options.UseFont = True
        Me.TypeNameLabel.Appearance.Options.UseTextOptions = True
        Me.TypeNameLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.TypeNameLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        resources.ApplyResources(Me.TypeNameLabel, "TypeNameLabel")
        Me.TableData.SetColumn(Me.TypeNameLabel, 4)
        Me.TypeNameLabel.Name = "TypeNameLabel"
        Me.TableData.SetRow(Me.TypeNameLabel, 0)
        '
        'TypeNameTextEdit
        '
        Me.TableData.SetColumn(Me.TypeNameTextEdit, 5)
        resources.ApplyResources(Me.TypeNameTextEdit, "TypeNameTextEdit")
        Me.TypeNameTextEdit.Name = "TypeNameTextEdit"
        Me.TypeNameTextEdit.Properties.Appearance.Font = CType(resources.GetObject("TypeNameTextEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.TypeNameTextEdit.Properties.Appearance.Options.UseFont = True
        Me.TypeNameTextEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.TypeNameTextEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.TypeNameTextEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.TypeNameTextEdit, 0)
        '
        'IsSlimLabel
        '
        Me.IsSlimLabel.Appearance.Font = CType(resources.GetObject("IsSlimLabel.Appearance.Font"), System.Drawing.Font)
        Me.IsSlimLabel.Appearance.Options.UseFont = True
        Me.IsSlimLabel.Appearance.Options.UseTextOptions = True
        Me.IsSlimLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.IsSlimLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        resources.ApplyResources(Me.IsSlimLabel, "IsSlimLabel")
        Me.TableData.SetColumn(Me.IsSlimLabel, 1)
        Me.IsSlimLabel.Name = "IsSlimLabel"
        Me.TableData.SetRow(Me.IsSlimLabel, 1)
        '
        'IsSlimCheckEdit
        '
        Me.TableData.SetColumn(Me.IsSlimCheckEdit, 2)
        resources.ApplyResources(Me.IsSlimCheckEdit, "IsSlimCheckEdit")
        Me.IsSlimCheckEdit.Name = "IsSlimCheckEdit"
        Me.IsSlimCheckEdit.Properties.Appearance.Font = CType(resources.GetObject("IsSlimCheckEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.IsSlimCheckEdit.Properties.Appearance.Options.UseFont = True
        Me.IsSlimCheckEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.IsSlimCheckEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.IsSlimCheckEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.IsSlimCheckEdit.Properties.Caption = resources.GetString("IsSlimCheckEdit.Properties.Caption")
        Me.TableData.SetRow(Me.IsSlimCheckEdit, 1)
        '
        'TLPBut
        '
        ...
        CType(Me.TypeNameTextEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.IsSlimCheckEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private WithEvents DGV As DevExpress.XtraGrid.GridControl
		...
		Friend WithEvents TypeNameTextEdit As DevExpress.XtraEditors.TextEdit
		Friend WithEvents TypeNameLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colTypeName As DevExpress.XtraGrid.Columns.GridColumn
		Friend WithEvents IsSlimCheckEdit As DevExpress.XtraEditors.CheckEdit
		Friend WithEvents IsSlimLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colIsSlim As DevExpress.XtraGrid.Columns.GridColumn
