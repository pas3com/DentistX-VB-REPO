...
#Region "Windows Form Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmImprDet))
        ...
        Me.colImpDetID = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colimprID = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colImprDetail = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.ImpDetIDLabel = New DevExpress.XtraEditors.LabelControl()
        Me.ImpDetIDSpinEdit = New DevExpress.XtraEditors.SpinEdit()
        Me.imprIDLabel = New DevExpress.XtraEditors.LabelControl()
        Me.ImpressionCombo = New DentistX.ImpressionCombo()
        Me.ImprDetailLabel = New DevExpress.XtraEditors.LabelControl()
        Me.ImprDetailTextEdit = New DevExpress.XtraEditors.TextEdit()
        ...
        CType(Me.ImpDetIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.ImprDetailTextEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.dgView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colRowNum, Me.colImpDetID, Me.colimprID, Me.colImprDetail})
        ...
        'colImpDetID
        '
        resources.ApplyResources(Me.colImpDetID, "colImpDetID")
        Me.colImpDetID.FieldName = "ImpDetID"
        Me.colImpDetID.ImageOptions.ImageKey = resources.GetString("colImpDetID.ImageOptions.ImageKey")
        Me.colImpDetID.Name = "colImpDetID"
        '
        'colimprID
        '
        resources.ApplyResources(Me.colimprID, "colimprID")
        Me.colimprID.FieldName = "impression Type"
        Me.colimprID.ImageOptions.ImageKey = resources.GetString("colimprID.ImageOptions.ImageKey")
        Me.colimprID.Name = "colimprID"
        Me.colimprID.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem()})
        '
        'colImprDetail
        '
        resources.ApplyResources(Me.colImprDetail, "colImprDetail")
        Me.colImprDetail.FieldName = "Impression Detail"
        Me.colImprDetail.ImageOptions.ImageKey = resources.GetString("colImprDetail.ImageOptions.ImageKey")
        Me.colImprDetail.Name = "colImprDetail"
        Me.colImprDetail.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem()})
        '
        'ribbonControl
        '
        ...
        Me.TableData.Controls.Add(Me.ImpDetIDLabel)
        Me.TableData.Controls.Add(Me.ImpDetIDSpinEdit)
        Me.TableData.Controls.Add(Me.imprIDLabel)
        Me.TableData.Controls.Add(Me.ImpressionCombo)
        Me.TableData.Controls.Add(Me.ImprDetailLabel)
        Me.TableData.Controls.Add(Me.ImprDetailTextEdit)
        ...
        'ImpDetIDLabel
        '
        resources.ApplyResources(Me.ImpDetIDLabel, "ImpDetIDLabel")
        Me.ImpDetIDLabel.Appearance.Font = CType(resources.GetObject("ImpDetIDLabel.Appearance.Font"), System.Drawing.Font)
        Me.ImpDetIDLabel.Appearance.Options.UseFont = True
        Me.ImpDetIDLabel.Appearance.Options.UseTextOptions = True
        Me.ImpDetIDLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImpDetIDLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.ImpDetIDLabel, 1)
        Me.ImpDetIDLabel.Name = "ImpDetIDLabel"
        Me.TableData.SetRow(Me.ImpDetIDLabel, 0)
        '
        'ImpDetIDSpinEdit
        '
        resources.ApplyResources(Me.ImpDetIDSpinEdit, "ImpDetIDSpinEdit")
        Me.TableData.SetColumn(Me.ImpDetIDSpinEdit, 2)
        Me.ImpDetIDSpinEdit.Name = "ImpDetIDSpinEdit"
        Me.ImpDetIDSpinEdit.Properties.Appearance.Font = CType(resources.GetObject("ImpDetIDSpinEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.ImpDetIDSpinEdit.Properties.Appearance.Options.UseFont = True
        Me.ImpDetIDSpinEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.ImpDetIDSpinEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImpDetIDSpinEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.ImpDetIDSpinEdit, 0)
        '
        'imprIDLabel
        '
        resources.ApplyResources(Me.imprIDLabel, "imprIDLabel")
        Me.imprIDLabel.Appearance.Font = CType(resources.GetObject("imprIDLabel.Appearance.Font"), System.Drawing.Font)
        Me.imprIDLabel.Appearance.Options.UseFont = True
        Me.imprIDLabel.Appearance.Options.UseTextOptions = True
        Me.imprIDLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.imprIDLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.imprIDLabel, 4)
        Me.imprIDLabel.Name = "imprIDLabel"
        Me.TableData.SetRow(Me.imprIDLabel, 0)
        '
        'ImpressionCombo
        '
        resources.ApplyResources(Me.ImpressionCombo, "ImpressionCombo")
        Me.TableData.SetColumn(Me.ImpressionCombo, 5)
        Me.ImpressionCombo.ImprID = 0
        Me.ImpressionCombo.ImprType = Nothing
        Me.ImpressionCombo.Name = "ImpressionCombo"
        Me.TableData.SetRow(Me.ImpressionCombo, 0)
        '
        'ImprDetailLabel
        '
        resources.ApplyResources(Me.ImprDetailLabel, "ImprDetailLabel")
        Me.ImprDetailLabel.Appearance.Font = CType(resources.GetObject("ImprDetailLabel.Appearance.Font"), System.Drawing.Font)
        Me.ImprDetailLabel.Appearance.Options.UseFont = True
        Me.ImprDetailLabel.Appearance.Options.UseTextOptions = True
        Me.ImprDetailLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImprDetailLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.ImprDetailLabel, 1)
        Me.ImprDetailLabel.Name = "ImprDetailLabel"
        Me.TableData.SetRow(Me.ImprDetailLabel, 1)
        '
        'ImprDetailTextEdit
        '
        resources.ApplyResources(Me.ImprDetailTextEdit, "ImprDetailTextEdit")
        Me.TableData.SetColumn(Me.ImprDetailTextEdit, 2)
        Me.ImprDetailTextEdit.Name = "ImprDetailTextEdit"
        Me.ImprDetailTextEdit.Properties.Appearance.Font = CType(resources.GetObject("ImprDetailTextEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.ImprDetailTextEdit.Properties.Appearance.Options.UseFont = True
        Me.ImprDetailTextEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.ImprDetailTextEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImprDetailTextEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.ImprDetailTextEdit, 1)
        '
        'TLPBut
        '
        ...
        'BS
        '
        Me.BS.DataSource = GetType(DentistX.Impression)
        '
        'FrmImprDet
        '
        ...
        CType(Me.ImpDetIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.ImprDetailTextEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Friend WithEvents ImpDetIDSpinEdit As DevExpress.XtraEditors.SpinEdit
    Friend WithEvents ImpDetIDLabel As DevExpress.XtraEditors.LabelControl
    Friend WithEvents colImpDetID As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents imprIDLabel As DevExpress.XtraEditors.LabelControl
    Friend WithEvents colimprID As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents ImprDetailTextEdit As DevExpress.XtraEditors.TextEdit
    Friend WithEvents ImprDetailLabel As DevExpress.XtraEditors.LabelControl
    Friend WithEvents colImprDetail As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents ImpressionCombo As DentistX.ImpressionCombo
