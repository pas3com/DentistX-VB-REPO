...
#Region "Windows Form Designer generated code"
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmImpClrs))
        ...
        Me.colImpClrID = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colImpClr = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.ImpClrIDLabel = New DevExpress.XtraEditors.LabelControl()
        Me.ImpClrIDSpinEdit = New DevExpress.XtraEditors.SpinEdit()
        Me.ImpClrLabel = New DevExpress.XtraEditors.LabelControl()
        Me.ImpClrTextEdit = New DevExpress.XtraEditors.TextEdit()
        ...
        CType(Me.ImpClrIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.ImpClrTextEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.dgView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colRowNum, Me.colImpClrID, Me.colImpClr})
        ...
        'colImpClrID
        '
        resources.ApplyResources(Me.colImpClrID, "colImpClrID")
        Me.colImpClrID.FieldName = "ImpClrID"
        Me.colImpClrID.ImageOptions.ImageKey = resources.GetString("colImpClrID.ImageOptions.ImageKey")
        Me.colImpClrID.Name = "colImpClrID"
        '
        'colImpClr
        '
        resources.ApplyResources(Me.colImpClr, "colImpClr")
        Me.colImpClr.FieldName = "ImpClr"
        Me.colImpClr.ImageOptions.ImageKey = resources.GetString("colImpClr.ImageOptions.ImageKey")
        Me.colImpClr.Name = "colImpClr"
        Me.colImpClr.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem()})
        '
        'ribbonControl
        '
        ...
        Me.TableData.Controls.Add(Me.ImpClrIDLabel)
        Me.TableData.Controls.Add(Me.ImpClrIDSpinEdit)
        Me.TableData.Controls.Add(Me.ImpClrLabel)
        Me.TableData.Controls.Add(Me.ImpClrTextEdit)
        ...
        'ImpClrIDLabel
        '
        resources.ApplyResources(Me.ImpClrIDLabel, "ImpClrIDLabel")
        Me.ImpClrIDLabel.Appearance.Font = CType(resources.GetObject("ImpClrIDLabel.Appearance.Font"), System.Drawing.Font)
        Me.ImpClrIDLabel.Appearance.Options.UseFont = True
        Me.ImpClrIDLabel.Appearance.Options.UseTextOptions = True
        Me.ImpClrIDLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImpClrIDLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.ImpClrIDLabel, 1)
        Me.ImpClrIDLabel.Name = "ImpClrIDLabel"
        Me.TableData.SetRow(Me.ImpClrIDLabel, 0)
        '
        'ImpClrIDSpinEdit
        '
        resources.ApplyResources(Me.ImpClrIDSpinEdit, "ImpClrIDSpinEdit")
        Me.TableData.SetColumn(Me.ImpClrIDSpinEdit, 2)
        Me.ImpClrIDSpinEdit.Name = "ImpClrIDSpinEdit"
        Me.ImpClrIDSpinEdit.Properties.Appearance.Font = CType(resources.GetObject("ImpClrIDSpinEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.ImpClrIDSpinEdit.Properties.Appearance.Options.UseFont = True
        Me.ImpClrIDSpinEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.ImpClrIDSpinEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImpClrIDSpinEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.ImpClrIDSpinEdit, 0)
        '
        'ImpClrLabel
        '
        resources.ApplyResources(Me.ImpClrLabel, "ImpClrLabel")
        Me.ImpClrLabel.Appearance.Font = CType(resources.GetObject("ImpClrLabel.Appearance.Font"), System.Drawing.Font)
        Me.ImpClrLabel.Appearance.Options.UseFont = True
        Me.ImpClrLabel.Appearance.Options.UseTextOptions = True
        Me.ImpClrLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImpClrLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetColumn(Me.ImpClrLabel, 4)
        Me.ImpClrLabel.Name = "ImpClrLabel"
        Me.TableData.SetRow(Me.ImpClrLabel, 0)
        '
        'ImpClrTextEdit
        '
        resources.ApplyResources(Me.ImpClrTextEdit, "ImpClrTextEdit")
        Me.TableData.SetColumn(Me.ImpClrTextEdit, 5)
        Me.ImpClrTextEdit.Name = "ImpClrTextEdit"
        Me.ImpClrTextEdit.Properties.Appearance.Font = CType(resources.GetObject("ImpClrTextEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.ImpClrTextEdit.Properties.Appearance.Options.UseFont = True
        Me.ImpClrTextEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.ImpClrTextEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.ImpClrTextEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.ImpClrTextEdit, 0)
        '
        'TLPBut
        '
        ...
        CType(Me.ImpClrIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.ImpClrTextEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private WithEvents DGV As DevExpress.XtraGrid.GridControl
		...
		Friend WithEvents ImpClrIDSpinEdit As DevExpress.XtraEditors.SpinEdit
		Friend WithEvents ImpClrIDLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colImpClrID As DevExpress.XtraGrid.Columns.GridColumn
		Friend WithEvents ImpClrTextEdit As DevExpress.XtraEditors.TextEdit
		Friend WithEvents ImpClrLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colImpClr As DevExpress.XtraGrid.Columns.GridColumn
