...
#Region "Windows Form Designer generated code"
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmLabOrder2))
        ...
        Me.Splitter1.SplitterPosition = 281
        '
        'DGV
        '
        ...
        'TableData
        '
        Me.TableData.Columns.AddRange(New DevExpress.Utils.Layout.TablePanelColumn() {New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 31.84!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 43.16!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 95.0!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 22.24!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 37.76!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 87.44!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 32.56!)})
        ...
        Me.TableData.Rows.AddRange(New DevExpress.Utils.Layout.TablePanelRow() {New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 26.0!), New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 31.0!), New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 34.0!), New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 31.0!), New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 29.0!), New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 30.0!), New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 33.0!), New DevExpress.Utils.Layout.TablePanelRow(DevExpress.Utils.Layout.TablePanelEntityStyle.Absolute, 26.0!)})
        ...
        'ImprDetCombo1
        '
        Me.ImprDetCombo1.BtnAddVisible = True
        Me.ImprDetCombo1.BtnSearchVisible = True
        Me.TableData.SetColumn(Me.ImprDetCombo1, 2)
        resources.ApplyResources(Me.ImprDetCombo1, "ImprDetCombo1")
        Me.ImprDetCombo1.Filter = ""
        Me.ImprDetCombo1.ImpDetID = 1
        Me.ImprDetCombo1.ImprDetail = "432"
        Me.ImprDetCombo1.ImprID = 1
        Me.ImprDetCombo1.Name = "ImprDetCombo1"
        Me.TableData.SetRow(Me.ImprDetCombo1, 2)
        '
        'ImpClrsCombo1
        '
        Me.ImpClrsCombo1.BtnAddVisible = True
        Me.ImpClrsCombo1.BtnSearchVisible = True
        Me.TableData.SetColumn(Me.ImpClrsCombo1, 5)
        resources.ApplyResources(Me.ImpClrsCombo1, "ImpClrsCombo1")
        Me.ImpClrsCombo1.Filter = ""
        Me.ImpClrsCombo1.ImpClr = "A-2"
        Me.ImpClrsCombo1.ImpClrID = 1
        Me.ImpClrsCombo1.Name = "ImpClrsCombo1"
        Me.TableData.SetRow(Me.ImpClrsCombo1, 2)
        '
        'ImpressionCombo1
        '
        Me.ImpressionCombo1.BtnAddVisible = True
        Me.ImpressionCombo1.BtnSearchVisible = True
        Me.TableData.SetColumn(Me.ImpressionCombo1, 5)
        resources.ApplyResources(Me.ImpressionCombo1, "ImpressionCombo1")
        Me.ImpressionCombo1.Filter = ""
        Me.ImpressionCombo1.ImprID = 1
        ...
        Me.colLabCombo.BtnAddVisible = True
        Me.colLabCombo.BtnSearchVisible = True
        Me.TableData.SetColumn(Me.colLabCombo, 5)
        resources.ApplyResources(Me.colLabCombo, "colLabCombo")
        Me.colLabCombo.Filter = ""
        Me.colLabCombo.LabID = 1
        ...
        Me.colPatientCombo.BtnAddVisible = True
        Me.colPatientCombo.BtnSearchVisible = True
