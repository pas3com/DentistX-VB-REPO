...
#Region "Windows Form Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Frm_TblCities))
        Me.Splitter1 = New DevExpress.XtraEditors.SplitContainerControl()
        Me.DGV = New DevExpress.XtraGrid.GridControl()
        Me.TblCitiesBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        ...
        Me.CityNameTextEdit = New DevExpress.XtraEditors.TextEdit()
        Me.CityIDSpinEdit = New DevExpress.XtraEditors.SpinEdit()
        ...
        CType(Me.TblCitiesBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.CityNameTextEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.CityIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'Splitter1
        '
        ...
        'DGV
        '
        Me.DGV.DataSource = Me.TblCitiesBindingSource
        ...
        '
        Me.TblCitiesBindingSource.DataMember = "TblCities"
        '
        'dgView
        '
        ...
        Me.dgView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colRowNum, Me.colCityID, Me.colCityName})
        ...
        'TableData
        '
        Me.TableData.Columns.AddRange(New DevExpress.Utils.Layout.TablePanelColumn() {New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 85.0!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 25.95!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 34.18!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 6.71!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 36.64!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 15.9!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 16.55!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 44.52!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 85.0!)})
        Me.TableData.Controls.Add(Me.TLPBut)
        Me.TableData.Controls.Add(Me.CityNameTextEdit)
        Me.TableData.Controls.Add(Me.CityIDSpinEdit)
        ...
        'CityNameTextEdit
        '
        Me.TableData.SetColumn(Me.CityNameTextEdit, 5)
        Me.TableData.SetColumnSpan(Me.CityNameTextEdit, 3)
        resources.ApplyResources(Me.CityNameTextEdit, "CityNameTextEdit")
        Me.CityNameTextEdit.MenuManager = Me.ribbonControl
        Me.CityNameTextEdit.Name = "CityNameTextEdit"
        Me.CityNameTextEdit.Properties.Appearance.Font = CType(resources.GetObject("CityNameTextEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.CityNameTextEdit.Properties.Appearance.Options.UseFont = True
        Me.TableData.SetRow(Me.CityNameTextEdit, 0)
        '
        'CityIDSpinEdit
        '
        Me.TableData.SetColumn(Me.CityIDSpinEdit, 2)
        resources.ApplyResources(Me.CityIDSpinEdit, "CityIDSpinEdit")
        Me.CityIDSpinEdit.MenuManager = Me.ribbonControl
        Me.CityIDSpinEdit.Name = "CityIDSpinEdit"
        Me.CityIDSpinEdit.Properties.Appearance.Font = CType(resources.GetObject("CityIDSpinEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.CityIDSpinEdit.Properties.Appearance.Options.UseFont = True
        Me.CityIDSpinEdit.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton(CType(resources.GetObject("CityIDSpinEdit.Properties.Buttons"), DevExpress.XtraEditors.Controls.ButtonPredefines))})
        Me.TableData.SetRow(Me.CityIDSpinEdit, 0)
        '
        'LabelControl4
        '
        ...
        CType(Me.TblCitiesBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.CityNameTextEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.CityIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Friend WithEvents TblCitiesBindingSource As Windows.Forms.BindingSource
    ...
    Friend WithEvents CityNameTextEdit As DevExpress.XtraEditors.TextEdit
