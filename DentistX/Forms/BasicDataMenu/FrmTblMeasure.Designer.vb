...
#Region "Windows Form Designer generated code"
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTblMeasure))
        ...
        Me.colMeasureID = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colMeasure = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.MeasureIDLabel = New DevExpress.XtraEditors.LabelControl()
        Me.MeasureIDSpinEdit = New DevExpress.XtraEditors.SpinEdit()
        Me.MeasureLabel = New DevExpress.XtraEditors.LabelControl()
        ...
        CType(Me.MeasureIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.dgView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colRowNum, Me.colMeasureID, Me.colMeasure})
        ...
        'colMeasureID
        '
        Me.colMeasureID.FieldName = "MeasureID"
        Me.colMeasureID.Name = "colMeasureID"
        '
        'colMeasure
        '
        Me.colMeasure.FieldName = "Measure"
        Me.colMeasure.Name = "colMeasure"
        resources.ApplyResources(Me.colMeasure, "colMeasure")
        '
        'ribbonControl
        '
        ...
        'TableData
        '
        Me.TableData.Columns.AddRange(New DevExpress.Utils.Layout.TablePanelColumn() {New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 70.0!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 50.0!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 50.0!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 10.0!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 50.0!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 82.45!), New DevExpress.Utils.Layout.TablePanelColumn(DevExpress.Utils.Layout.TablePanelEntityStyle.Relative, 37.55!)})
        Me.TableData.Controls.Add(Me.MeasureIDLabel)
        Me.TableData.Controls.Add(Me.MeasureIDSpinEdit)
        Me.TableData.Controls.Add(Me.MeasureLabel)
        Me.TableData.Controls.Add(Me.MeasureTextEdit)
        ...
        'MeasureIDLabel
        '
        Me.MeasureIDLabel.Appearance.Font = CType(resources.GetObject("MeasureIDLabel.Appearance.Font"), System.Drawing.Font)
        Me.MeasureIDLabel.Appearance.Options.UseFont = True
        Me.MeasureIDLabel.Appearance.Options.UseTextOptions = True
        Me.MeasureIDLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.MeasureIDLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        resources.ApplyResources(Me.MeasureIDLabel, "MeasureIDLabel")
        Me.TableData.SetColumn(Me.MeasureIDLabel, 1)
        Me.MeasureIDLabel.Name = "MeasureIDLabel"
        Me.TableData.SetRow(Me.MeasureIDLabel, 0)
        '
        'MeasureIDSpinEdit
        '
        Me.TableData.SetColumn(Me.MeasureIDSpinEdit, 2)
        resources.ApplyResources(Me.MeasureIDSpinEdit, "MeasureIDSpinEdit")
        Me.MeasureIDSpinEdit.Name = "MeasureIDSpinEdit"
        Me.MeasureIDSpinEdit.Properties.Appearance.Font = CType(resources.GetObject("MeasureIDSpinEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.MeasureIDSpinEdit.Properties.Appearance.Options.UseFont = True
        Me.MeasureIDSpinEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.MeasureIDSpinEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.MeasureIDSpinEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.MeasureIDSpinEdit, 0)
        '
        'MeasureLabel
        '
        Me.MeasureLabel.Appearance.Font = CType(resources.GetObject("MeasureLabel.Appearance.Font"), System.Drawing.Font)
        Me.MeasureLabel.Appearance.Options.UseFont = True
        Me.MeasureLabel.Appearance.Options.UseTextOptions = True
        Me.MeasureLabel.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.MeasureLabel.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        resources.ApplyResources(Me.MeasureLabel, "MeasureLabel")
        Me.TableData.SetColumn(Me.MeasureLabel, 4)
        Me.MeasureLabel.Name = "MeasureLabel"
        Me.TableData.SetRow(Me.MeasureLabel, 0)
        '
        'MeasureTextEdit
        '
        Me.TableData.SetColumn(Me.MeasureTextEdit, 5)
        resources.ApplyResources(Me.MeasureTextEdit, "MeasureTextEdit")
        Me.MeasureTextEdit.Name = "MeasureTextEdit"
        Me.MeasureTextEdit.Properties.Appearance.Font = CType(resources.GetObject("MeasureTextEdit.Properties.Appearance.Font"), System.Drawing.Font)
        Me.MeasureTextEdit.Properties.Appearance.Options.UseFont = True
        Me.MeasureTextEdit.Properties.Appearance.Options.UseTextOptions = True
        Me.MeasureTextEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        Me.MeasureTextEdit.Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center
        Me.TableData.SetRow(Me.MeasureTextEdit, 0)
        '
        'TLPBut
        '
        ...
        CType(Me.MeasureIDSpinEdit.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private WithEvents DGV As DevExpress.XtraGrid.GridControl
		...
		Friend WithEvents MeasureIDSpinEdit As DevExpress.XtraEditors.SpinEdit
		Friend WithEvents MeasureIDLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colMeasureID As DevExpress.XtraGrid.Columns.GridColumn
		Friend WithEvents MeasureTextEdit As DevExpress.XtraEditors.TextEdit
		Friend WithEvents MeasureLabel As DevExpress.XtraEditors.LabelControl
		Friend WithEvents colMeasure As DevExpress.XtraGrid.Columns.GridColumn
