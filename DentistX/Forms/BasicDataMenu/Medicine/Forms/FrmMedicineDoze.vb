...
Partial Public Class FrmMedicineDoze
 ...
 End Sub
 Private clsMedicineDozeData As New MedicineDozeData
 Private clsDentistXData As New DentistXData
 
 
 Private Sub FrmMedicineDoze_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
     LoadDGV()
 ...
 Private Sub LoadDGV()
     Try
         With DGV
             .DataSource = clsMedicineDozeData.SelectAll
 ...
 Private Sub EnableRecord(ByVal YesNo As Boolean)
        'DozeIDSpinEdit.Enabled = YesNo
        ShapeIDSpinEdit.Enabled = YesNo
        DozeTextEdit.Enabled = YesNo
 End Sub
 ...
 Private Sub Display()
     ClearRecord()
     Dim clsMedicineDoze As New MedicineDoze
        clsMedicineDoze.DozeID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colDozeID))
    clsMedicineDoze = clsMedicineDozeData.Select_Record(clsMedicineDoze)
     If Not clsMedicineDoze Is Nothing Then
     Try
        DozeIDSpinEdit.Value = System.Convert.ToInt32(clsMedicineDoze.DozeID)
        ShapeIDSpinEdit.Value = System.Convert.ToInt32(clsMedicineDoze.ShapeID)
        DozeTextEdit.Text = Convert.ToString(clsMedicineDoze.Doze)
     Catch ex As Exception
          MsgBox(ex.Message)
     End Try
     End If
 ...
 Private Sub ClearRecord()
    DozeIDSpinEdit.Value = 0
    ShapeIDSpinEdit.Value = 0
    DozeTextEdit.Text = Nothing
 End Sub
 ...
 End Sub
 Private Sub SetData(ByVal clsMedicineDoze As MedicineDoze)
     With clsMedicineDoze
        .DozeID = System.Convert.ToInt32(DozeIDSpinEdit.Value)
        .ShapeID = System.Convert.ToInt32(ShapeIDSpinEdit.Value)
        .Doze = System.Convert.ToString(DozeTextEdit.Text)
     End With
 End Sub
    ...
    Private Sub InsertRecord()
        ...
        If VerifyData() = True Then
            SetData(clsMedicineDoze)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineDozeData.Add(clsMedicineDoze)
    ...
    Private Sub UpdateRecord()
        Dim oclsMedicineDoze As New MedicineDoze
        Dim clsMedicineDoze As New MedicineDoze
        oclsMedicineDoze.DozeID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colDozeID))
        oclsMedicineDoze = clsMedicineDozeData.Select_Record(oclsMedicineDoze)
        If VerifyData() = True Then
            SetData(clsMedicineDoze)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineDozeData.Update(oclsMedicineDoze, clsMedicineDoze)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Sub DeleteRecord()
        ...
        If result = DialogResult.Yes Then
            Dim bSuccess As Boolean
            bSuccess = clsMedicineDozeData.Delete(clsMedicineDoze)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Function VerifyData() As Boolean
        ...
        If DozeIDSpinEdit.Value = Nothing OrElse DozeIDSpinEdit.Value.ToString() = "" Then
            MsgBox("DozeID is required.", MsgBoxStyle.OkOnly, "Entry Error")
            DozeIDSpinEdit.Select()
            Return False
        End If
