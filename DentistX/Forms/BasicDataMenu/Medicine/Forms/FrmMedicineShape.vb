...
Partial Public Class FrmMedicineShape
 ...
 End Sub
 Private clsMedicineShapeData As New MedicineShapeData
 Private clsDentistXData As New DentistXData
 
 
 Private Sub FrmMedicineShape_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
     LoadDGV()
 ...
 Private Sub LoadDGV()
     Try
         With DGV
             .DataSource = clsMedicineShapeData.SelectAll
 ...
 Private Sub EnableRecord(ByVal YesNo As Boolean)
        'ShapeIDSpinEdit.Enabled = YesNo
        MedicineItemIDSpinEdit.Enabled = YesNo
        MedicineShapeTextEdit.Enabled = YesNo
        ShapeInfoTextEdit.Enabled = YesNo
 End Sub
 ...
 Private Sub Display()
     ClearRecord()
     Dim clsMedicineShape As New MedicineShape
        clsMedicineShape.ShapeID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colShapeID))
    clsMedicineShape = clsMedicineShapeData.Select_Record(clsMedicineShape)
     If Not clsMedicineShape Is Nothing Then
     Try
        ShapeIDSpinEdit.Value = System.Convert.ToInt32(clsMedicineShape.ShapeID)
        MedicineItemIDSpinEdit.Value = System.Convert.ToInt32(clsMedicineShape.MedicineItemID)
        MedicineShapeTextEdit.Text = Convert.ToString(clsMedicineShape.MedicineShape)
        ShapeInfoTextEdit.Text = Convert.ToString(clsMedicineShape.ShapeInfo)
     Catch ex As Exception
          MsgBox(ex.Message)
     End Try
     End If
 ...
 Private Sub ClearRecord()
    ShapeIDSpinEdit.Value = 0
    MedicineItemIDSpinEdit.Value = 0
    MedicineShapeTextEdit.Text = Nothing
    ShapeInfoTextEdit.Text = Nothing
 End Sub
 ...
 End Sub
 Private Sub SetData(ByVal clsMedicineShape As MedicineShape)
     With clsMedicineShape
        .ShapeID = System.Convert.ToInt32(ShapeIDSpinEdit.Value)
        .MedicineItemID = System.Convert.ToInt32(MedicineItemIDSpinEdit.Value)
        .MedicineShape = System.Convert.ToString(MedicineShapeTextEdit.Text)
        .ShapeInfo = System.Convert.ToString(ShapeInfoTextEdit.Text)
     End With
 End Sub
    ...
    Private Sub InsertRecord()
        ...
        If VerifyData() = True Then
            SetData(clsMedicineShape)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineShapeData.Add(clsMedicineShape)
    ...
    Private Sub UpdateRecord()
        Dim oclsMedicineShape As New MedicineShape
        Dim clsMedicineShape As New MedicineShape
        oclsMedicineShape.ShapeID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colShapeID))
        oclsMedicineShape = clsMedicineShapeData.Select_Record(oclsMedicineShape)
        If VerifyData() = True Then
            SetData(clsMedicineShape)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineShapeData.Update(oclsMedicineShape, clsMedicineShape)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Sub DeleteRecord()
        ...
        If result = DialogResult.Yes Then
            Dim bSuccess As Boolean
            bSuccess = clsMedicineShapeData.Delete(clsMedicineShape)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Function VerifyData() As Boolean
        ...
        If ShapeIDSpinEdit.Value = Nothing OrElse ShapeIDSpinEdit.Value.ToString() = "" Then
            MsgBox("ShapeID is required.", MsgBoxStyle.OkOnly, "Entry Error")
            ShapeIDSpinEdit.Select()
            Return False
        End If
