...
Partial Public Class FrmMedicineFamily
 ...
 End Sub
 Private clsMedicineFamilyData As New MedicineFamilyData
 Private clsDentistXData As New DentistXData
 
 
 Private Sub FrmMedicineFamily_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
     LoadDGV()
 ...
 Private Sub LoadDGV()
     Try
         With DGV
             .DataSource = clsMedicineFamilyData.SelectAll
 ...
 Private Sub EnableRecord(ByVal YesNo As Boolean)
        ...
        MedicineIDSpinEdit.Enabled = YesNo
        MedicineSubCatTextEdit.Enabled = YesNo
 End Sub
 ...
 Private Sub Display()
     ClearRecord()
     Dim clsMedicineFamily As New MedicineFamily
        clsMedicineFamily.SubCatID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colSubCatID))
    clsMedicineFamily = clsMedicineFamilyData.Select_Record(clsMedicineFamily)
     If Not clsMedicineFamily Is Nothing Then
     Try
        SubCatIDSpinEdit.Value = System.Convert.ToInt32(clsMedicineFamily.SubCatID)
        MedicineIDSpinEdit.Value = System.Convert.ToInt32(clsMedicineFamily.MedicineID)
        MedicineSubCatTextEdit.Text = Convert.ToString(clsMedicineFamily.MedicineSubCat)
     Catch ex As Exception
          MsgBox(ex.Message)
     End Try
     End If
 ...
 Private Sub ClearRecord()
    ...
    MedicineIDSpinEdit.Value = 0
    MedicineSubCatTextEdit.Text = Nothing
 End Sub
 ...
 End Sub
 Private Sub SetData(ByVal clsMedicineFamily As MedicineFamily)
     With clsMedicineFamily
        .SubCatID = System.Convert.ToInt32(SubCatIDSpinEdit.Value)
        .MedicineID = System.Convert.ToInt32(MedicineIDSpinEdit.Value)
        .MedicineSubCat = System.Convert.ToString(MedicineSubCatTextEdit.Text)
     End With
 End Sub
    ...
    Private Sub InsertRecord()
        ...
        If VerifyData() = True Then
            SetData(clsMedicineFamily)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineFamilyData.Add(clsMedicineFamily)
    ...
    Private Sub UpdateRecord()
        Dim oclsMedicineFamily As New MedicineFamily
        Dim clsMedicineFamily As New MedicineFamily
        oclsMedicineFamily.SubCatID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colSubCatID))
        oclsMedicineFamily = clsMedicineFamilyData.Select_Record(oclsMedicineFamily)
        If VerifyData() = True Then
            SetData(clsMedicineFamily)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineFamilyData.Update(oclsMedicineFamily, clsMedicineFamily)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Sub DeleteRecord()
        ...
        If result = DialogResult.Yes Then
            Dim bSuccess As Boolean
            bSuccess = clsMedicineFamilyData.Delete(clsMedicineFamily)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Function VerifyData() As Boolean
        ...
        If SubCatIDSpinEdit.Value = Nothing OrElse SubCatIDSpinEdit.Value.ToString() = "" Then
            ...
            Return False
        End If
        If MedicineIDSpinEdit.Value = Nothing OrElse MedicineIDSpinEdit.Value.ToString() = "" Then
            MsgBox("MedicineSubCat is required.", MsgBoxStyle.OkOnly, "Entry Error")
            MedicineIDSpinEdit.Select()
            Return False
        End If
        If MedicineSubCatTextEdit.Text = "" Then
            MsgBox("MedicineSubCat is required.", MsgBoxStyle.OkOnly, "Entry Error")
            MedicineSubCatTextEdit.Select()
            Return False
        End If
        Return True
    End Function
