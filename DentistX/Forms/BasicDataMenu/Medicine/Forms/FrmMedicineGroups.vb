...
Partial Public Class FrmMedicineGroups
 ...
 End Sub
 Private clsMedicineGroupsData As New MedicineGroupsData
 Private clsDentistXData As New DentistXData
 
 
 Private Sub FrmMedicineGroups_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
     LoadDGV()
 ...
 Private Sub LoadDGV()
     Try
         With DGV
             .DataSource = clsMedicineGroupsData.SelectAll
 ...
 Private Sub EnableRecord(ByVal YesNo As Boolean)
        ...
        MedicineFamilyTextEdit.Enabled = YesNo
 End Sub
 ...
 Private Sub Display()
     ClearRecord()
     Dim clsMedicineGroups As New MedicineGroups
        clsMedicineGroups.MedicineID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colMedicineID))
    clsMedicineGroups = clsMedicineGroupsData.Select_Record(clsMedicineGroups)
     If Not clsMedicineGroups Is Nothing Then
     Try
        MedicineIDSpinEdit.Value = System.Convert.ToInt32(clsMedicineGroups.MedicineID)
        MedicineFamilyTextEdit.Text = Convert.ToString(clsMedicineGroups.MedicineFamily)
     Catch ex As Exception
          MsgBox(ex.Message)
     End Try
     End If
 ...
 Private Sub ClearRecord()
    ...
    MedicineFamilyTextEdit.Text = Nothing
 End Sub
 ...
 End Sub
 Private Sub SetData(ByVal clsMedicineGroups As MedicineGroups)
     With clsMedicineGroups
        .MedicineID = System.Convert.ToInt32(MedicineIDSpinEdit.Value)
        .MedicineFamily = System.Convert.ToString(MedicineFamilyTextEdit.Text)
     End With
 End Sub
    ...
    Private Sub InsertRecord()
        ...
        If VerifyData() = True Then
            SetData(clsMedicineGroups)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineGroupsData.Add(clsMedicineGroups)
    ...
    Private Sub UpdateRecord()
        Dim oclsMedicineGroups As New MedicineGroups
        Dim clsMedicineGroups As New MedicineGroups
        oclsMedicineGroups.MedicineID = System.Convert.ToInt32(dgView.GetRowCellDisplayText(Row, colMedicineID))
        oclsMedicineGroups = clsMedicineGroupsData.Select_Record(oclsMedicineGroups)
        If VerifyData() = True Then
            SetData(clsMedicineGroups)
            Dim bSuccess As Boolean
            bSuccess = clsMedicineGroupsData.Update(oclsMedicineGroups, clsMedicineGroups)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Sub DeleteRecord()
        ...
        If result = DialogResult.Yes Then
            Dim bSuccess As Boolean
            bSuccess = clsMedicineGroupsData.Delete(clsMedicineGroups)
            If bSuccess = True Then
                GoBack_To_Grid()
            Else
    ...
    Private Function VerifyData() As Boolean
        ...
        If MedicineIDSpinEdit.Value = Nothing OrElse MedicineIDSpinEdit.Value.ToString() = "" Then
            ...
            Return False
        End If
        If MedicineFamilyTextEdit.Text = "" Then
            MsgBox("MedicineFamily is required.", MsgBoxStyle.OkOnly, "Entry Error")
            MedicineFamilyTextEdit.Select()
            Return False
        End If
        Return True
    End Function
